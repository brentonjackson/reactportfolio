...
class Thumbnail extends React.Component {
	...
	render() {	
		return (
			<a onMouseEnter={this.mouseEnter.bind(this)} onMouseLeave={this.mouseLeave.bind(this)} className={this.state.className + " project-tile bounceInLeft slower"} target="_blank" href={this.props.link}>
