  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        <style>
          {
            ".prefix__f{fill:#004445}.prefix__h{fill:#f0eff3}.prefix__j{fill:#fff}"
          }
        </style>
      </defs>
      <g id="prefix__o" clipPath="url(#prefix__p)">
        <g transform="translate(-114 38.615)">
          ...
          <path
            ...
            transform="translate(214.419 346.21)"
            fill="url(#prefix__b)"
          />
          <path
          ...
          <path
            ...
            transform="translate(208.209 297.444)"
          />
          <rect
            className="prefix__h"
            width={42.659}
          ...
          <path
            ...
            transform="translate(236.943 288.758)"
            fill="url(#prefix__d)"
          />
          <path
            className="prefix__f"
            d="M65.634 94.857L11.987 83.6A14.667 14.667 0 01.642 64.889L20.9 11.227 25.212.144s41.656-1.792 44.252 7.277c3.981 13.742 1 33.487-.8 40.382-3.081 11.879-3.5 26.41-3.5 26.41l4.49 1.823a7.19 7.19 0 011.736.661l4.379 3.813-3.049 13.7-5.287.716a5.254 5.254 0 01-1.8-.071z"
            transform="translate(167.192 208.2)"
          />
          <path
          ...
          <path
            ...
            transform="translate(224.061 114.713)"
            fill="url(#prefix__i)"
          />
          <path
            className="prefix__f"
          ...
          />
          <path
            d="M221.728 128.264a9.96 9.96 0 007.962 9.554c8.038 1.846 12.778-4.777 12.778-4.777"
            strokeWidth={0.67}
            strokeLinecap="round"
            fill="none"
            stroke="#fff"
